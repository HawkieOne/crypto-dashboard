...
1. Clone the repo
   ```sh
   git clone https://github.com/HawkieOne/crypto-dashboard
   ```
...
<br />
Project Link: [https://github.com/HawkieOne/crypto-dashboard](https://github.com/HawkieOne/crypto-dashboardt)
